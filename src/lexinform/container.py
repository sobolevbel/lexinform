...
class Container:
    ...
    def text_sources(self) -> TextSources:
        ...
        return TextSources(
            SejmTextSource(self.gateway),
            rcl=rcl,
            submissions=SubmissionTextSource(self.settings.orka_base_url),
        )
    ...
    def pipeline(self, *, dry_run: bool) -> DailyPipeline:
        return self._once(
            ...
            lambda: DailyPipeline(
                ...
                history_payload_retention_days=self.settings.history_payload_retention_days,
                analysis_memo_retention_days=self.settings.analysis_memo_retention_days,

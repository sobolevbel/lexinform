...
`docs/roadmap.md`; the defects this bot has had and the shapes it keeps repeating in
`docs/BUGS.md` — read its last section before hunting for a new one; everything else in
`README.md`.

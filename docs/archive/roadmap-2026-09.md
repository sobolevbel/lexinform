...
# Исторический roadmap · сентябрь 2026

Статус: заменён [текущим roadmap](../roadmap.md) 24 сентября 2026.
Снимок прежних измерений и решений; открытые задачи здесь не обновляются.

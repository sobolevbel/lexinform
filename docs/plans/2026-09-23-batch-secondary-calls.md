...
23.09.2026. План; исполнение не начато.
...
5. **Дедлайн** `llm_batch_max_wait_hours` = 6. Для задания он считается от подачи, для билла — от
...
## Фаза 5 — amendments (за гейтом 0.3)
